...
const YEARLY_THEMES = [
  { key: 'career', houses: [10, 6], labelUr: 'کیریئر و کاروبار', labelEn: 'Career & Work' },
  { key: 'health', houses: [1, 6, 8], labelUr: 'صحت و توانائی', labelEn: 'Health & Energy' },
  { key: 'relationships', houses: [7, 5], labelUr: 'رشتے و ازدواجی زندگی', labelEn: 'Relationships & Family' },
  { key: 'finance', houses: [2, 11], labelUr: 'مالی معاملات', labelEn: 'Finance' },
  { key: 'general', houses: [9, 12, 3, 4], labelUr: 'عمومی رجحان و روحانیت', labelEn: 'General & Spiritual' },
];
...
function buildYearlyThemed(lines, extra, lang) {
  const themed = YEARLY_THEMES.map((t) => {
    ...
    return {
      key: t.key,
      label: lang === 'ur' ? t.labelUr : t.labelEn,
  ...
  if (extra && extra.length) {
    themed.push({
      key: 'overall',
      label: lang === 'ur' ? 'مجموعی صورتحال' : 'Overall picture',
      lines: extra,
    });
  }
  return themed;
