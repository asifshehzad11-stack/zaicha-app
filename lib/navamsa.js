...
function buildNavamsaChart(data) {
  ...
  for (let h = 1; h <= 12; h++) {
    ...
    houses.push({
      ...
      // English planet name bhi saath deते hain (jaise sign/signLatin) — taake
      // frontend bina extra lang-param pass kiye currentLang ke mutabiq
      // sahi label dikha sake (multi-language foundation).
