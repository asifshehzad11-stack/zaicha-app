...
//   2. Cuspal Sub-Lords (poora KP Significator/horary system, jo Placidus
//      HOUSE CUSPS par mabni hota hai): NAHI banaye gaye — is app ka
//      house system whole-sign/equal hai (Placidus cusp-calculation wire
//      nahi), is liye sirf PLANET + Ascendant ke sub-lords di gaye hain,
//      poora KP significator-hierarchy (4-level: Planet/Star Lord/Sub
//      Lord/Sub-Sub Lord, cuspal significators) implement nahi hua — ye
//      khud ek naya, bada feature hoga.
'use strict';
...
function buildKpInfo(data) {
  ...
  return {
    ...
    cuspalSubLordsSupported: false, // disclosed limitation — header comment dekhein
  };
}
